...
//
//     final hpCharacters = hpCharactersFromJson(jsonString);

// ignore_for_file: constant_identifier_names

import 'dart:convert';

List<HpCharacters> hpCharactersFromJson(String str) => List<HpCharacters>.from(
    json.decode(str).map((x) => HpCharacters.fromJson(x)));

String hpCharactersToJson(List<HpCharacters> data) =>
...
class HpCharacters {
  ...
  factory HpCharacters.fromJson(Map<String, dynamic> json) => HpCharacters(
        id: json["id"],
        name: json["name"],
